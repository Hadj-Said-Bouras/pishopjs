    ...
    <div className='flex flex-col md:flex-row justify-center gap-20 mt-20 mb-20'>
      <div className='flex flex-col md:flex-row h-[500px] gap-10 ml-2 mr-2'>
        <div className='flex flex-row md:flex-col gap-2 justify-center'>
          <Image src={product.imgUrl} width={120} height={120} alt='Product Image' className='bg-gray-100'/>
          <Image src={product.imgUrl} width={120} height={120} alt='Product Image' className='bg-gray-100'/>
          <Image src={product.imgUrl} width={120} height={120} alt='Product Image' className='bg-gray-100'/>
          <Image src={product.imgUrl} width={120} height={120} alt='Product Image' className='bg-gray-100'/>
        </div>
        <div className='flex justify-center -order-1 md:order-1 items-center bg-gray-100'>
          <Image src={product.imgUrl} width={400} height={400} alt='Product Image' />
        </div>
      </div>
      <div className='w-full md:w-1/3'>
        <div className='flex flex-col gap-2 mx-2 md:mx-0'>
          <h1 className='font-bold absolute md:static top-[200px] md:flex ml-5 md:ml-0 text-xl'>{product.title}</h1>
          <div className='flex flex-col md:flex-row items-center mr-5'>
            ...
            <p className='text-gray-400'>{`(${product.reviews} reviews)`} | <span className='text-cyan-300'>In Stock</span></p>
          </div>   
          <h3 className='font-semibold text-xl'><span className='md:hidden'>Price: </span>{product.price}</h3>
